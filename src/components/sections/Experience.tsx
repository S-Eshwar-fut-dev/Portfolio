...
const experiences = [
    {
        ...
        company: "Gaotek Inc",
        period: "Internship",
        description: "Specialized in WordPress development, E-commerce solutions, and optimizing web performance.",
        icon: Briefcase,
        side: "left"
    },
    {
        ...
        period: "Leadership",
        description: "Led a team of 10 full-stack developers to build a comprehensive Curriculum Management System.",
        icon: Code,
        side: "right"
    }
]
                                    ...
                                    <div className="p-8 md:p-10 rounded-3xl bg-[#020617] border border-cyan-500/30 hover:border-cyan-400/60 transition-colors shadow-[0_0_30px_rgba(6,182,212,0.1)] relative group overflow-hidden">
                                        ...
                                        <div className="flex items-center gap-6 mb-6">
                                            ...
                                            <div>
                                                ...
                                                <span className="text-cyan-400/80 font-mono text-sm tracking-wider uppercase">{exp.period}</span>
                                            </div>
                                        </div>

                                        <h4 className="text-xl font-bold text-slate-100 mb-4">{exp.title}</h4>
